public class QueenCoco extends Coco {
	...
	public boolean canCapture() {
		...
		if(from.getDoggo() != null && toUR != null && middleUR.getDoggo() != null && toUR.getDoggo() == null &&
				...
				(middleUR.getDoggo().getType().equals("Frodo") || (middleUR.getDoggo().getType().equals("King")))){
			return true;
		}
		//Jumping Upper Left
		if(from.getDoggo() != null && toUL != null && middleUL.getDoggo() != null && toUL.getDoggo() == null &&
				...
				(middleUL.getDoggo().getType().equals("Frodo") || (middleUL.getDoggo().getType().equals("King")))){
			return true;
		}
		//Jumping Lower Right
		if(from.getDoggo() != null && toLR != null && middleLR.getDoggo() != null && toLR.getDoggo() == null &&
				...
				(middleLR.getDoggo().getType().equals("Frodo") || (middleLR.getDoggo().getType().equals("King")))){
			return true;
		}//Jumping Lower Left
		if(from.getDoggo() != null && toLL != null && middleLL.getDoggo() != null && toLL.getDoggo() == null &&
				...
				(middleLL.getDoggo().getType().equals("Frodo") || (middleLL.getDoggo().getType().equals("King")))){
			return true;
		}
		return false;
	}
